...
<div class="body-box" style="float:right">
	<form id="jvForm" action="/sjgjsend/data/sendmsm.action" method="post" enctype="multipart/form-data">
		...
		<table cellspacing="1" cellpadding="2" width="100%" border="0" class="pn-ftable">
			<tbody id="tab_1">
					...
					<td width="20%" class="pn-flabel pn-flabel-h">
						<span class="pn-frequired">*</span>
						注意:</td><td width="80%" class="pn-fcontent">
					发送内容不要超过70个字符，超过70将按多条发送
					</td>
				</tr>
					<tr>
					<td width="20%" class="pn-flabel pn-flabel-h">
					...
					<textarea class="required" name="content" rows="3" cols="45" ></textarea>
					</td>
				</tr>
			</tbody>
