...
<div id="top">
     <div class="top">
          ...
          <tr>
            <td width="215"><div class="logo"><img src="../res/itcast/img/admin/sjgj.jpg" width="215" height="69" /></div></td>
            <td valign="top">
                <div class="topbg">
                     <div class="login-welcome">
                             <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                  <tr>
                                    ...
                                    <img src="../res/itcast/img/admin/loginout-icon.png"/>退出
                                    <img src="../res/itcast/img/admin/message-unread.png"/>&nbsp;你有<span id="countDiv">0</span>条信息未读</a>
                                    </td>
                                  </tr>
                                </table>
                       </div>  
                     <div class="nav">
                     	  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                              <tr>
                                ...
                                <td>
                                	<ul class="nav-menu">
                                    	<li class="current" id="tb_11" onclick="HoverLi(11);"><a href="/sjgjsend/back/main.action" target="mainFrame">首页</a></li>
										<li class="sep"></li><li class="normal" id="tb_12" onclick="HoverLi(12);"><a href="/sjgjsend/book/book_main.action" target="mainFrame">图书管理</a></li>
                            			<li class="sep"></li><li class="normal" id="tb_13" onclick="HoverLi(13);"><a href="/sjgjsend/data/data_main.action" target="mainFrame">数据管理</a></li>
                            			<!-- <li class="sep"></li><li class="normal" id="tb_14" onclick="HoverLi(14);"><a href="/sjgjsend/data/data_main.action" target="mainFrame">推送消息</a></li> -->
