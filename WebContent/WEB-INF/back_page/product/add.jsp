...
<!-- <script type="text/javascript">
	...
	function uploadword(){
		// 通过jquery.form.js实现form表单提交
		var options = {
				url:"/uploadword.action",
				type:"post",
				dataType:"json",
				success:function(data){
					// 1、图片回显；2、将图片的路径保存到隐藏域中
				/* 	$("#allImgUrl").attr("src",data.allImgUrl); // 图片回显 */
					$("#describeUrl").val(data.describeUrl); // 设置隐藏域的值
				}
		}
...
<div class="box-positon">
	<div class="rpos">当前位置: 图书库管理 - 添加</div>
	<form class="ropt">
...
<div class="body-box" style="float:right">
	<form id="jvForm" action="/sjgjsend/book/save.action" method="post" enctype="multipart/form-data">
		<table cellspacing="1" cellpadding="2" width="100%" border="0" class="pn-ftable">
			<tbody id="tab_1">
				<tr>
					...
					<td width="20%" class="pn-flabel pn-flabel-h">
						...
						<input type="text" class="required" name="bookyear" value="" maxlength="300" size="10"/>
					</td>
				</tr>
				<tr>
					<td width="20%" class="pn-flabel pn-flabel-h">
						...
						<input type="text" class="required" name="bookname" value="" maxlength="300" size="60"/>
					</td>
				</tr>
			...
			<!-- <tbody id="tab_2" style="display: none">
				<tr>
					<td >
						<textarea rows="5" cols="5" id="productdesc" name="decribeUrl"></textarea>
					</td>
				</tr>
			</tbody> -->
			<tbody>
