...
<div class="body-box" style="float:right">
	<form id="jvForm" action="/sjgjsend/pstorebook/save.action" method="post" enctype="multipart/form-data">
			...
			<tbody id="tab_1">
				<tr>
					<td width="20%" class="pn-flabel pn-flabel-h">
						...
						<input type="text" class="required" name="pid" value="" maxlength="300" size="20"/>
					</td>
				</tr>
				<tr>
					<td width="20%" class="pn-flabel pn-flabel-h">
